...
export function SessionPanel({
  ...
  if (collapsed) {
    return (
      <div className="w-9 flex-shrink-0 bg-[#faf9f7] border-r border-border flex flex-col items-center pt-2 gap-1.5">
        <button
  ...
  return (
    <div className="w-[220px] flex-shrink-0 bg-[#faf9f7] border-r border-border flex flex-col">
      {/* Header */}
